    ...
    if ($wynik1) {
        ...
        if ($wynik1->num_rows > 0) {
            ...
            while ($wiersz = $wynik1->fetch_assoc()) {
                ...
                $model = $wiersz["model"];
                echo "<tr>";
                echo "<td class='clr1'><img width='40%' src='../mobileapp_car_rental/" . $wiersz["zdjecie"] . "'></td>";
                echo "<td class='clr1'>" . $marka . "</td>";
                echo "<td class='clr2'>" . $model . "</td>";
                ...
                echo "<td><a href='reservation.php?marka=$marka&model=$model' class='btn btn-primary'>Rezerwuj</a></td>";
                echo "</tr>";
            }
            echo "</table>";
            $polaczenie->close();
